    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="card-02" id="div-app">
                    ...
                    <center>
                        ...
                        if(isset($_POST['regstud'])){
                            ...
                            $pwd=$_POST["pwd"];
							$ssem=$_POST["sem"];
							$sql="insert into registration values('$admn', '$name', '$mob', '$mail', '$pwd', 0, '$ssem')";
							$conn->query($sql);
                ...
                <div class="card-02 ocard-02" id="div-rem">
			...
			<div class="row">
				<div class="card-03">
					...
					if(isset($_POST['vstudent'])){
						$vname=$_POST['vvalue'];
						$sql="SELECT * FROM results JOIN registration ON restults.admn=registration.admn";
						$result=$conn->query($sql);
						echo $result;
						if($result->num_rows>0){
							echo $row['mobile'];
